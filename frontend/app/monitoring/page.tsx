...
const defaultOverlayItems = [
  ...
  { label: "navigation line", checked: true },
  { label: "navigation direction", checked: true },
  { label: "virtual wall line", checked: false },
  { label: "navigation node", checked: false },
  { label: "work station point", checked: false },
  { label: "transport line", checked: true },
  { label: "allocated node", checked: true },
];
          ...
          >
            <section className={mapMode === "3d" ? "monitoring-map is-3d" : "monitoring-map"}>
              <div
                ...
                onWheel={mapMode === "2d" ? handleMapWheel : undefined}
              >
                {mapMode === "3d" ? (
                  "Map (3D View)"
                ) : (
